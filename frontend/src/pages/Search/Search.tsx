...
import HotelTypesFilter from "../../components/HotelTypeFilter/HotelTypeFilter";
...
const Search = () => {
    ...
    return (
        <div className="grid grid-1 lg:grid-cols-[250px_1fr] gap-5">
            ...
            <div className="flex flex-col gap-5">
                <div className="flex justify-between items-center">
                    <div className=" font-bold flex justify-between items-center w-full">
                        <div className="text-xl"> {hotelData?.pagination.total} Hotels found
